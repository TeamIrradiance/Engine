...
void EngineCore::DefineMeta()
{
  ...
  meta_begin( Vector3 )
  meta_child(Vector3,Vector3::m_vec3.x)
  meta_child(Vector3,Vector3::m_vec3.y)
  meta_child(Vector3,Vector3::m_vec3.z)
  meta_end()

  meta_begin( Vector4 )
  meta_child(Vector4, Vector4::m_vec4.x)
  meta_child(Vector4,Vector4::m_vec4.y)
  meta_child(Vector4,Vector4::m_vec4.z)
  meta_child(Vector4,Vector4::m_vec4.w)
  meta_end()

  meta_begin( Vector2 )
  meta_child(Vector2,Vector2::m_vec2.x)
  meta_child(Vector2,Vector2::m_vec2.y)
  meta_end()
